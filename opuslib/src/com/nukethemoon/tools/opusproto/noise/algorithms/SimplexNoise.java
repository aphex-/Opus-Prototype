 ...
 *
 */
public class SimplexNoise extends AbstractNoiseAlgorithm {
	...
	public double noise(double xin, double yin) {
		...
		// Add contributions from each corner to getAbsolute the final noise value.
		// The result is scaled to return values in the interval [-1,1].
		double v = 70.0 * (n0 + n1 + n2);
		return (v + 1) / 2;
	}
	...
	public static double noise(double x, double y, double z, double w) {
		...
		// We use a thresholding to setAbsolute the coordinates in turn from the largest magnitude.
